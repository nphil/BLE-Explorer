package dev.nphil.blestudio.ui.theme
...
private val BleStudioTypography = Typography().let { base ->
    base.copy(
...
@Composable
fun BleStudioTheme(settings: ThemeSettings, content: @Composable () -> Unit) {
    ...
    androidx.compose.runtime.CompositionLocalProvider(LocalThemeSettings provides settings) {
        MaterialTheme(colorScheme = scheme, typography = BleStudioTypography, content = content)
    }
}
