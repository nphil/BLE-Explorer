...
import dev.nphil.blestudio.hci.BtsnoopParser
import dev.nphil.blestudio.hci.CollectAttempt
import dev.nphil.blestudio.hci.CollectProgress
import dev.nphil.blestudio.hci.CollectStage
import dev.nphil.blestudio.hci.ConnectionSummary
import dev.nphil.blestudio.hci.DissectionContext
import dev.nphil.blestudio.hci.DissectionNode
import dev.nphil.blestudio.hci.HciDissector
import dev.nphil.blestudio.hci.ParseSummary
import dev.nphil.blestudio.hci.SnoopCapabilities
import dev.nphil.blestudio.hci.SnoopController
import dev.nphil.blestudio.hci.SnoopMode
import dev.nphil.blestudio.hci.dissectionContextOf
import dev.nphil.blestudio.hci.enrich
...
import dev.nphil.blestudio.shell.SHIZUKU_PACKAGE
...
class CaptureViewModel(private val container: AppContainer) : ViewModel() {
     ...
     *
     * The change is applied inside [dev.nphil.blestudio.data.SessionStore.update], so it patches
