 ...
 *
 * A relay outlives the screen that started it: [dev.nphil.blueshark.service.BleForegroundService]
...
object RelaySession {
    ...
    /** Every event of the current recording, for persisting into a [dev.nphil.blueshark.model.CaptureSession]. */
