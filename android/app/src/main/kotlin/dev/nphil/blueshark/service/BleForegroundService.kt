...
class BleForegroundService : LifecycleService() {
    ...
    private fun createChannel() {
        val channel = NotificationChannel(
            ...
            description = "Shown while BlueShark holds a Bluetooth connection or relays one"
            setShowBadge(false)
        }
    ...
    companion object {
        ...
        private const val EXTRA_MODE = "dev.nphil.blueshark.extra.LINK_MODE"
        private const val EXTRA_ADDRESS = "dev.nphil.blueshark.extra.LINK_ADDRESS"
        private const val ACTION_STOP = "dev.nphil.blueshark.action.STOP_LINK"
        private const val ACTION_RELEASE = "dev.nphil.blueshark.action.RELEASE_LINK"
        private const val CHANNEL_ID = "blueshark_link"
